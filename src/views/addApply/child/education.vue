  ...
  <div class="wrap">
    <Form ref="person" :model="person" :rules="ruleValidate" :label-width="150">
      <FormItem label="学历" prop="degree">
        <Input v-model="person.degree" placeholder="请输入您的学历" />
      </FormItem>
      <FormItem label="毕业日期" prop="graduateTime">
        <DatePicker type="month" placeholder="" v-model="person.graduateTime"></DatePicker>
      </FormItem>
